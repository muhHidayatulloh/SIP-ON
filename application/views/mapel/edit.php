            ...
            <div class="col-sm-12">
                <div class="card card-info">
                    ...
                    <div class="card-body col-sm-11">
                        <input type="hidden" name="id" value="<?= $mapel->kd_mapel; ?>">
                        <div class="form-group row">
                            <label for="nama_mapel" class="col-sm-2 col-form-label text-lg-right">Mata Pelajaran</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?= (validation_errors()) ? 'is-invalid' : ''; ?>" placeholder="Masukkan Nama Mata Pelajaran" name="nama_mapel" value="<?php echo set_value('nama_mapel'); ?> <?= $mapel->nama_mapel; ?>" id="inputError">
