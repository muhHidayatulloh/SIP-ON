            ...
            <div class="col-sm-12">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title">Form Tambah Kurikulum</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php
                    ...
                    <div class="card-body col-sm-11">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?= (validation_errors()) ? 'is-invalid' : ''; ?>" placeholder="Masukkan Nama Kurikulum" name="nama_kurikulum" value="<?php echo set_value('nama_kurikulum'); ?>" id="inputError">
