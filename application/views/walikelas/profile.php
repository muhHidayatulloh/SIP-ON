                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="timeline">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <form action="<?= base_url('walikelas/profile') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="tab-pane" id="settings">
                                <form class="form-horizontal" oninput='password2.setCustomValidity(password2.value != password1.value ? "Kata Sandi tidak cocok." : "")' method="POST" action="<?= base_url('walikelas/profile')?>">
                                    <input type="hidden" name="id" value="<?= $user->id_guru; ?>">
